                ...
                >
                    {marqueeItems.map((logo, index) => (
                        <motion.div
                            ...
                            className="relative z-0 flex h-25 w-42.5 shrink-0 cursor-pointer items-center justify-center rounded-2xl border border-gray-200 bg-white p-4 shadow-sm transition-shadow duration-300 hover:z-10 hover:shadow-xl md:h-[150px] md:w-[250px]"
                        >
                            <img
                                src={logo.client_logo}
                                alt={logo.altTag || logo.client_name}
