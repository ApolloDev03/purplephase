  ...
  return (
    <main className="">
      ...
      <section className="bg-[#F6F6F6] pb-10">
        <div className="mx-auto max-w-full px-5 sm:px-8 lg:px-16">
          {/* Years */}
          ...
          {/* Content */}
          <div className="mt-8 ">
            <p className="text-[20px] leading-[1.75] text-[#5A5A5A]">
            ...
            <p className="mt-7 text-[20px] leading-[1.75] text-[#5A5A5A]">
            ...
            <h3 className="mt-8 text-[22px] font-bold uppercase tracking-[0.4px] text-[#F28C00] leading-[1.45]">
              SO FOR US, PRECISION HAS NEVER BEEN ABOUT SKILL, BUT A BASIC INSTINCT.
            </h3>

            <button className="group mt-7 inline-flex h-[44px] items-center rounded-full bg-[#9C1367] px-6 text-[16px] font-semibold text-white transition-all duration-300 hover:bg-[#7d0f55]">
              Leverage Legacy
              <MoveUpRight className="ml-2 h-4 w-4 transition-transform duration-300 group-hover:translate-x-1 group-hover:-translate-y-1" />
            </button>
          </div>
        </div>
      </section>
...
<div className="w-full lg:w-[58%] flex flex-col justify-center">
    ...
    <div className="relative mt-24 min-h-[230px] ">
      ...
      <AnimatePresence mode="wait">
        {member && (
          ...
          >
            <h3 className="text-[38px] font-bold uppercase text-primary">
              {member.name}
            </h3>

            <p className="mt-8 text-[30px] font-bold uppercase tracking-[1px] text-primary">
              {member.designation}
            </p>

            <p className="mt-2 max-w-[520px] text-[22px] leading-[1.55] text-[#555555]">
              {member.description}
            </p>
          </motion.div>
        )}
    ...
    <div className="mt-8 flex items-center gap-12">
      ...
      <button
        ...
        className="group"
      >
        <ArrowLeft className="h-10 w-10 text-[#9B9B9B] transition group-hover:-translate-x-1" />
      </button>
      ...
      <button
        ...
        className="group"
      >
        <ArrowRight className="h-10 w-10 text-[#9B9B9B] transition group-hover:translate-x-1" />
      </button>
      ...
      <div className="w-full lg:w-[42%] flex justify-center lg:justify-end">
        ...
        <div className="relative h-[760px] w-full max-w-[560px] overflow-hidden">
