              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a
                    ...
                    className="break-all text-[16px] text-[#4a4a4a] underline decoration-[#4a4a4a]/60 underline-offset-2 transition-colors hover:text-[#a20d69] md:text-[18px] lg:text-[21px]"
                  >
            ...
            <div className="mt-16 grid grid-cols-1 gap-x-2 gap-y-12 md:grid-cols-3">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-[16px] leading-[1.6] text-[#4a4a4a] xl:text-[21px]!">
